...
public class AlarmReceiver2 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        i.putExtra("notification", "lunch");
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        PendingIntent pendingIntent = PendingIntent.getActivity(context, 2, i, PendingIntent.FLAG_IMMUTABLE);

        RemoteViews contentView = new RemoteViews(context.getPackageName(), R.layout.notification_layout);
        contentView.setTextViewText(R.id.textView1, "Lunch Time");
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "BreakFast")
                ...
                .setContentTitle("Lunch time")                          //Title of the Notification
